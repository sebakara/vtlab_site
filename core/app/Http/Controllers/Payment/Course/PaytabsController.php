...
class PaytabsController extends Controller
{
    ...
    public function redirectToPaytabs(Request $request)
    {
        /************************************
        ...
        if ($bse->base_currency_text != $paytabInfo['currency']) {
            return redirect()->back()->with('error', __('Invalid Currency For Paytabs Payment.'));
        }
        ...
        $course_purchase->payment_method = 'paytabs';
        ...
        $notify_url = route('course.paytabs.notify');
        ...
        $description = 'Course Enrollment via paytabs';
        try {
